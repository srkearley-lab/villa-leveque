...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      {/* Bottom fade for booking card overlap */}
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[rgba(15,26,36,0.5)] to-transparent" />

      {/* Main content */}
      <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto w-full pt-24 pb-32">
        ...
        <motion.div
          ...
          className="flex items-center justify-start sm:justify-center gap-2 overflow-x-auto pb-1 px-1 scrollbar-hide"
